export default function Review({ img, title, price, info, link, icon }) {
    return (
        <div className="specials_card">
            ...
            <div className="card_wrapper">
                <h3 className="specials_card-title" id={title}>
                    {title}
                </h3>
            ...
            <div className="card_order">
                <a className="greeksalad_link" href={title} id={title}>{link}</a>
