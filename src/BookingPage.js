import rest from "./icons_assets/restaurant2.jpg"
import chef from "./icons_assets/chefB.jpg"
            ...
            <div className="wrapper">
                ...
                <form className="information">
                    ...
                    <div className="radio">
                        ...
                        <label for="inside">Inside</label><br></br>
                        <input name="side" type="radio" value="Outside"></input>
                        <label for="outside">Outside</label><br></br>
                    </div>
